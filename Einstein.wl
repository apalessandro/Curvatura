...
RicciTensor::usage = "Ricci_Tensor[g,x] returns the Ricci Tensor corresponding to the metric g and coordinates x";
RicciScalar::usage = "Ricci_Scalar[g,x] returns the Ricci Scalar corresponding to the metric g and coordinates x";
EinsteinTensor::usage = "Einstein_Tensor[g,x] returns the Einstein Tensor corresponding to the metric g and coordinates x";
